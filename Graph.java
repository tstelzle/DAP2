...
public class Graph
{
	...
	public double getCost(int src, int dest){
		//System.out.println("i, " + src + " j, " + dest + " ,length src: " +  costs.length + ", length dest: " + costs[src].length);
		//HIER IST EIN FEHLER IM CODE!!!!!!!!!!!!!!!
		if (src >= costs.length || costs[src].length <= dest )
		{
